...
// const images = [ book, skull, moon, skulpt, picture, picture2 ];
				...
				<div className="App">
					...
					<Row className={this.state.hasScrolled ? 'fade-out' : 'fade-in'}>
						<Col className="header-heading">
							...
							<p>– Introducing to our vision, ideas and basicly shit we think is worth speaking about</p>
						</Col>
					</Row>
					...
					<Row className={this.state.hasScrolled ? 'fade-in header-3' : 'fade-out header-3'}>
						<Col className="column-art">
							<h1>
								Lorem ipsum<br />dolor sit amet
							</h1>
							<p>
								consectetuer adipiscing elit,<br /> sed diam nonummy nibh euismod<br /> tincidunt ut
								laoreet dolore<br /> magna aliquam erat volutpat. Ut<br /> wisi enim ad minim.
							</p>

							<Button className="btn-read">Read more</Button>
						</Col>
						<Col>
							<img src="http://www.laurenhakmiller.com/wp-content/uploads/2019/01/9.jpg" alt="Book" />
						</Col>
					</Row>
					<Row>
					...
					<Row>
						<Col className="lip-image">
							<img src="https://www.4montnait.com/wp-content/uploads/2019/02/lippen.jpg" alt="Lips" />
					...
					<Row>
						<Col className="last-p">
							<p>
								If you found this interesting, give others the<br /> opportunity to read it
							</p>
						</Col>
					</Row>
					<Row>
